...
namespace Cartagena_1_3
{
    class Lobby
    {
        ...
        public string EntrarPartida(/*string nome*/string idPartida, string nomeJogador, string senhaPartida)
        {
            ...
            {
                MensagemErro("limite50caracteres");
        ...
        public int CriarPartida(string nomePartida, string senhaPartida)
        {
            ...
            {
                MensagemErro("limite20caracteres");
                return 0;
            }
        ...
        public string ExibirTabuleiro(string idPartida)
        {
            ...
            {
                MensagemErro("partidainexistente");
                return "Erro ao mostrar tabuleiro";
            }
        ...
        public void MensagemSucesso(string tipoSucesso)
        {
            tipoSucesso.ToLower();
            tipoSucesso.Trim();
            switch (tipoSucesso)
        ...
        public void MensagemErro(string tipoErro)
        {
            tipoErro.ToLower();
            tipoErro.Trim();
            switch (tipoErro)
